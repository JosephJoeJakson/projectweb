...
class Browser:
    def __init__(self, root):
        self.root = root; self.root.title("Mini Browser – Step 6 (JS basics)")
        ...
        self.source_text = tk.Text(root, height=12); self.source_text.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
    ...
    def _apply_css(self, node, rules):
        ...
        for r in rules:
            ...
            for s in sels:
                if self._match(node,s): node.styles.update(r.get("style",{}))
